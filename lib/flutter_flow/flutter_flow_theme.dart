...
abstract class FlutterFlowTheme {
  ...
  static ThemeMode get themeMode {
    ...
    return darkMode == null
        ? ThemeMode.dark  // Default to dark mode for TV optimization
        : darkMode
            ? ThemeMode.dark
            : ThemeMode.light;
  }
  ...
  // TV Dashboard specific colors
  late Color glassBackground;
  late Color glassBorder;
  late Color purpleGlow;
  late Color blueGlow;
  late Color greenGlow;
  late Color whiteGlow;
...
class ThemeTypography extends Typography {
  ...
  TextStyle get displayLarge => GoogleFonts.urbanist(
        ...
        fontWeight: FontWeight.w900, // Extra bold for TV visibility
        fontSize: 57.0,
        shadows: [
          Shadow(
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFA855F7); // Purple for glassmorphic theme
  late Color secondary = const Color(0xFF60A5FA); // Blue for glassmorphic theme
  late Color tertiary = const Color(0xFF22C55E); // Green for glassmorphic theme
  late Color alternate = const Color(0xFF1A1A2E);
  late Color primaryText = const Color(0xFFEDEDED);
  late Color secondaryText = const Color(0xFFCCCCCC);
  late Color primaryBackground = const Color(0xFF0A0A0A); // Deep black for TV
  late Color secondaryBackground = const Color(0xFF0F0F0F);
  late Color accent1 = const Color(0x4CA855F7);
  late Color accent2 = const Color(0x4D60A5FA);
  late Color accent3 = const Color(0x4D22C55E);
  late Color accent4 = const Color(0xCCFFFFFF);
  ...
  late Color border = const Color(0xFF1A1A2E);
  late Color background = const Color(0xFF0A0A0A);
  late Color lila = const Color(0xFFA855F7);
  late Color purple = const Color(0xFFA855F7);

  // TV Dashboard specific colors
  late Color glassBackground = const Color(0x0DFFFFFF); // rgba(255, 255, 255, 0.05)
  late Color glassBorder = const Color(0x1AFFFFFF); // rgba(255, 255, 255, 0.1)
  late Color purpleGlow = const Color(0x99A855F7); // rgba(168, 85, 247, 0.6)
  late Color blueGlow = const Color(0x9960A5FA); // rgba(96, 165, 250, 0.6)
  late Color greenGlow = const Color(0x9922C55E); // rgba(34, 197, 94, 0.6)
  late Color whiteGlow = const Color(0xCCFFFFFF); // rgba(255, 255, 255, 0.8)
}

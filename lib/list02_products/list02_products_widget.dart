                    ...
                    child: FlutterFlowButtonTabBar(
                      ...
                      tabs: [
                        FutureBuilder<ApiCallResponse>(
                          future: XanoGroup.dealNotStartedCall.call(),
                          builder: (context, snapshot) {
                            ...
                            final tabDealNotStartedResponse = snapshot.data!;
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          FutureBuilder<ApiCallResponse>(
                                            future: XanoGroup.dealNotStartedCall
                                                .call(),
                                            builder: (context, snapshot) {
                                              // Customize what your widget looks like when it's loading.
                                              if (!snapshot.hasData) {
                                              ...
                                              final imageDealNotStartedResponse =
                                                  snapshot.data!;
                                              ...
                                              return ClipRRect(
                                                ...
                                                child: Image.network(
                                                  XanoGroup.dealNotStartedCall
                                                      .imageLogo(
                                                        imageDealNotStartedResponse
                                                            .jsonBody,
                                                      )!
                                                      .where((e) =>
                                                          valueOrDefault<bool>(

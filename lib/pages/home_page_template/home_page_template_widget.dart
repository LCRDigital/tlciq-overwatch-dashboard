...
class HomePageTemplateWidget extends StatefulWidget {
  ...
  static String routeName = 'HomePageTemplate';
  static String routePath = '/homePageTemplate';
...
class _HomePageTemplateWidgetState extends State<HomePageTemplateWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<DealRecord>>(
      stream: FFAppState().photo(
        requestFn: () => queryDealRecord(
          singleRecord: true,
        ),
      ),
      builder: (context, snapshot) {
        ...
        List<DealRecord> homePageTemplateDealRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final homePageTemplateDealRecord =
            homePageTemplateDealRecordList.isNotEmpty
                ? homePageTemplateDealRecordList.first
                : null;
                            ...
                            if (loggedIn == true)
                              Align(
                                ...
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 8.0, 0.0, 16.0),
                                  child: StreamBuilder<List<DealRecord>>(
                                    stream: queryDealRecord(),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                        return Center(
